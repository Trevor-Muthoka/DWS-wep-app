                        ...
                        <div id="nav-tab-card" class="tab-pane fade show active">
                            ...
                            <form action="{{ route('addService') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="servicename" placeholder="e.g Kuosha nguo" id="servicename" required class="form-control">
                                    <span class="text-danger">@error('servicename'){{$message}}@enderror</span>
                                </div>

                                <div class="form-group">
                                    <label for="payment">Payment Amount in Kshs:</label>
                                    <input type="number" name="payment" id="payment" placeholder="e.g 500" required class="form-control">
