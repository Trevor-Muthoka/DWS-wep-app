        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    <img src="assets2/img/avatar.png"  class="rounded-circle">
...
{{--            </ul>--}}
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="{{ route('client.postJob')}}">
                <i class="bi bi-file-earmark-post"></i><span>Post a Job</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
...
{{--                                </li>--}}
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-bookmark-check-fill"></i><span>Book a worker</span>
...
<footer id="footer" class="footer">
    <div class="copyright">
        &copy; Copyright <strong><span>Trevor & Natalie</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
